    ...
    switch mex
        ...
        case 'mexmaci64'
            error('blosc_matlab:install:UnknownPlatform', ...
                ['No prebuilt available for macOS Intel: GitHub is ' ...
                 'retiring the macos-13 runner (their only Intel ' ...
                 'image), so we do not currently attach a ' ...
                 'mexmaci64 asset. Run `build` from the repo root ' ...
                 'to compile from source (needs Xcode command-line ' ...
                 'tools and CMake).']);
        case 'mexa64'
